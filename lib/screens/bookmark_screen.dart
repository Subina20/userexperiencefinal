...
class BookmarkScreen extends StatefulWidget {
  ...
  static const String route = "BookmarkScreen";
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                return Text('Error fetching bookmarks: ${snapshot.error}');
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final postId = bookmark.get('postId');
                  ...
                  return StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                        return Container(); // Placeholder for non-existing posts
                      }

                      final postDocuments = snapshot.data!.docs;
                      final post =
                          postDocuments[0].data() as Map<String, dynamic>;
                                    ...
                                    children: [
                                      StreamBuilder<DocumentSnapshot>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final bookmarkData = snapshot.data
                                      ...
                                      StreamBuilder<DocumentSnapshot>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final isLiked =
                                              snapshot.data?.exists ?? false;
                                          final likeData = snapshot.data?.data()
